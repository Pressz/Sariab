...
function users(){
    $('#search').flexdatalist({
        ...
        url: Hi.home() + '/BridgeController.php' + "?" + "Id=dw_users4.sql" + "&Params=[param1:Username,param2:Firstname,param3:Lastname]&" + Hi.loginprotocol(),
        relatives: '#relative'
    });
}

$.get(Hi.home() + "/BridgeController.php?Id=dw_users2.sql"
