...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.tab_space_layout, this);
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_scie);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_entr);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_inte);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_resources);
     ...
     */
    public void initialize(ViewPager viewPager, FragmentManager fragmentManager, List<Fragment> fragments, Bundle savedInstanceState) {
        ...
        if (numberOfTabs == 3 && !iconOnly) {
            tabOne.setCustomView(R.layout.tab_text);
            tabTwo.setCustomView(R.layout.tab_text);
            tabThree.setCustomView(R.layout.tab_text);
            ...
            tabOne.setCustomView(R.layout.tab_layout);
            tabTwo.setCustomView(R.layout.tab_layout);
            tabThree.setCustomView(R.layout.tab_layout);
            if (numberOfTabs > 3) tabFour.setCustomView(R.layout.tab_layout);
            if (numberOfTabs > 4) tabFive.setCustomView(R.layout.tab_layout);
